...
*****************************************************************************************/
CPredictorCompressNormal::CPredictorCompressNormal(intn nCompressionLevel) 
...
*****************************************************************************************/
CPredictorDecompress3950toCurrent::CPredictorDecompress3950toCurrent(intn nCompressionLevel, intn nVersion)
    : IPredictorDecompress(nCompressionLevel, nVersion)
{
    m_nVersion = nVersion;
